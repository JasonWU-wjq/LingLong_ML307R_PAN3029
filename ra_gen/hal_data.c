...
const timer_cfg_t g_timer0_cfg =
{
    ...
    /* Actual period: 0.5 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x4000, .duty_cycle_counts = 0x2000, .source_div = (timer_source_div_t)0,
    .channel             = 0,
    .p_callback          = agt_callback,
...
sci_uart_instance_ctrl_t     g_uart9_ctrl;
            ...
            {
                /* Baud rate calculated with 0.394% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 1, .mddr = (uint8_t) 235, .semr_baudrate_bits_b.brme = true
            };
