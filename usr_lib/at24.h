...
#define   AT24_POWERON    ;//P12_bit.no5 = 1   VCC直供
...
unsigned char AT24_readbyte(unsigned int Addr,unsigned char* buf,unsigned int num);
unsigned char AT24_writebyte(unsigned int Addr,unsigned char *buf,unsigned int num);
